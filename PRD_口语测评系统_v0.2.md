...
| Part | 名称 | 分值 | 说明 |
|------|------|------|------|
| Part 1 | 词汇朗读 | 0-100 分 | Qwen-Omni 评测，题目数量动态配置 |
| Part 2 | 问答表达 | 0-100 分 | Qwen-Omni 评测，题目数量动态配置 |
| **总计** | - | **0-100 分** | Part 1 + Part 2 平均分 |
...
| Part | 分数来源 | 说明 |
|------|----------|------|
| Part1 | **Qwen-Omni 语音评测** | 直接输出 0-100 分（发音、流利度、完整度综合评分） |
| Part2 | **Qwen-Omni 语义评测** | 直接输出 0-100 分（内容理解、表达能力综合评分） |
